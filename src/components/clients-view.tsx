...
type Client = Account & { portfolio_count: number; latest_portfolio?: { portfolio_value?: number; holdings?: number; risk_score?: number }; latest_report_number?: string | null };
