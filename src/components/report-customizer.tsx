...
const sectionLabels: Record<string, { title: string; description: string }> = {
  ...
  insights: { title: "Portfolio insights", description: "Automated observations and highlights" },
  performance: { title: "Performance and returns", description: "Return analysis and performance charts" },
...
type Configuration = { title: string; subtitle: string; sections: Record<string, boolean>; exists?: boolean };
